...
(function() {
  ...
  define(["jquery", "js/spec_helpers/edit_helpers", "coffee/src/views/module_edit", "js/models/module_info", "xmodule"], function($, edit_helpers, ModuleEdit, ModuleModel) {
      ...
      return describe("methods", function() {
        ...
        describe("render", function() {
          ...
          it("loads js urls from fragments", function() {
            return expect($.getScript).toHaveBeenCalledWith("js-url");
          });
