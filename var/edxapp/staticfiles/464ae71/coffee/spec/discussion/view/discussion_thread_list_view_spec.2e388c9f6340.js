  ...
  describe("DiscussionThreadListView", function() {
    ...
    describe("thread rendering should be correct", function() {
      ...
      checkRender = function(threads, type, sort_order) {
        ...
        return expect(view.$el.find(".forum-nav-thread-votes-count:visible").length).toEqual(type === "votes" ? 4 : 0);
      };
      it("with sort preference date", function() {
        return checkRender(this.threads, "date", ["Thread1", "Thread4", "Thread2", "Thread3"]);
      });
    ...
    describe("Sort change should be correct", function() {
      ...
      it("with sort preference date", function() {
        return changeSorting(this.threads, "comments", "date", ["Thread1", "Thread4", "Thread2", "Thread3"]);
      });
      it("with sort preference votes", function() {
        return changeSorting(this.threads, "date", "votes", ["Thread4", "Thread1", "Thread2", "Thread3"]);
      });
      return it("with sort preference comments", function() {
