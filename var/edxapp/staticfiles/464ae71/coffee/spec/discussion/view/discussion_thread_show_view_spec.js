...
(function() {
  ...
  describe("DiscussionThreadShowView", function() {
    beforeEach(function() {
      ...
      return this.spyOn(this.view, "convertMath");
    });
    ...
    describe("pinning", function() {
      ...
      return it("handles events correctly", function() {
        this.view.render();
    ...
    describe("author display", function() {
      ...
      return it("renders correctly for an anonymously-authored thread", function() {
        var $el;
