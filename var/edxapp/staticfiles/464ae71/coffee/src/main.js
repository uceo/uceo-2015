...
(function() {
  ...
  define(["domReady", "jquery", "underscore.string", "backbone", "gettext", "js/views/feedback_notification", "coffee/src/ajax_prefix", "jquery.cookie"], function(domReady, $, str, Backbone, gettext, NotificationView) {
    var main;
    main = function() {
