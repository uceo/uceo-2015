...
(function() {
  ...
  define(["jquery", "underscore", "gettext", "xblock/runtime.v1", "js/views/xblock", "js/views/modals/edit_xblock"], function($, _, gettext, XBlock, XBlockView, EditXBlockModal) {
    var ModuleEdit;
    return ModuleEdit = (function(_super) {
      ...
      ModuleEdit.prototype.clickEditButton = function(event) {
        ...
        return modal.edit(this.$el, self.model, {
